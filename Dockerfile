...
COPY lib /lib
ADD alert-collector-1.0.jar /alert-collector.jar
...
ENTRYPOINT ["java",\
            ...
            "-Dcom.sun.management.jmxremote.port=30008",\
            "-Dcom.sun.management.jmxremote.rmi.port=30008",\
            "-Dcom.sun.management.jmxremote.ssl=false",\
            "-Dcom.sun.management.jmxremote.authenticate=false",\
            "-Dcom.sun.management.jmxremote.local.only=false",\
            "-jar","/alert-collector.jar"]
